package selfInfoMgr.docInfoMgr.service.impl;
...
import selfInfoMgr.docInfoMgr.dao.IDocInfoMgrDao;
import selfInfoMgr.docInfoMgr.service.IDocInfoMgrService;

@Service
@Transactional
public class DocInfoMgrServiceImpl implements IDocInfoMgrService {

	@Autowired
	private IDocInfoMgrDao docInfoMgrDao;
	...
	public Map<String, Object> getDocInfo() {
		...
		Map<String, Object> result = docInfoMgrDao.getDocInfo(param);
	...
	public void updateDocInfo(Map<String, Object> param) {
		docInfoMgrDao.updateDocInfo(param);;
	}
	...
	public String uploadDocPro(MultipartFile file) throws IllegalStateException, IOException {
        ...
        String path="";  
	        if(!file.isEmpty()){  
	            ...
	            docInfoMgrDao.uploadDocPro(update);;
        }
	        return path;
	}
	...
	public Map<String, String> getDocPro() {
		Map<String, String> param = new HashMap<String, String>();
		param.put("UUID", (String) session.getAttribute(GlobalConstant.LOGIN_USER));
		return docInfoMgrDao.getDocPro(param);
	}
